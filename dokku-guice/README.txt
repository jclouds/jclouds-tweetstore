...
Please modify your maven settings.xml like below before attempting to run 'mvn -Plive install'
    ...
    <profile>
      ...
      <properties>
        ...
        <test.twitter.dotcloud-tweetstore.consumer.identity>YOUR_TWITTER_CONSUMER_KEY</test.twitter.dotcloud-tweetstore.consumer.identity>
        <test.twitter.dotcloud-tweetstore.consumer.credential>YOUR_TWITTER_CONSUMER_SECRET</test.twitter.dotcloud-tweetstore.consumer.credential>
        <test.twitter.dotcloud-tweetstore.access.identity>YOUR_TWITTER_ACCESSTOKEN</test.twitter.dotcloud-tweetstore.access.identity>
        <test.twitter.dotcloud-tweetstore.access.credential>YOUR_TWITTER_ACCESSTOKEN_SECRET</test.twitter.dotcloud-tweetstore.access.credential>
      </properties>
    </profile>